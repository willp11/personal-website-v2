        ...
        <Observer>
            <div id="Contact" className="w-full mb-16">
                ...
                <div className="flex justify-center items-center mt-8">
                    <a href="https://twitter.com/will_page_dev" target="_blank" rel="noreferrer" aria-label="Link to Twitter"><TwitterLogo size="medium" /></a>
                    <span className="mx-8"><a href="https://github.com/willp11" target="_blank" rel="noreferrer" aria-label="Link to Github"><GithubLogo size="medium" /></a></span>
                    <a href="https://www.linkedin.com/in/william-page-80a063260" target="_blank" rel="noreferrer" aria-label="Link to LinkedIn"><LinkedinLogo size="medium" /></a>
                </div>
            </div>
        </Observer>
    );
