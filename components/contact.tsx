        ...
        <Observer>
            <div id="Contact" className="w-full mb-16">
                ...
                <div className="w-full flex flex-col items-center justify-center">
                    ...
                    <a href="mailto: will_page_dev@proton.me" target="_blank">
                        <div
                ...
                <div className="flex justify-center items-center mt-8">
                    ...
                    <span className="mx-8"><a href="https://github.com/willp11" target="_blank"><GithubLogo size="medium" /></a></span>
                    <a href="https://www.linkedin.com/in/william-page-80a063260" target="_blank"><LinkedinLogo size="medium" /></a>
                </div>
            </div>
        </Observer>
    );
